...
XCVAR_DEF(g_saberRealisticCombat, "2", NULL, CVAR_ARCHIVE, qfalse)
...
XCVAR_DEF(sv_fps, "50", NULL, CVAR_ARCHIVE | CVAR_SERVERINFO, qtrue)
...
XCVAR_DEF(g_adminpassword, "admin", NULL, CVAR_INTERNAL, qfalse)
