...
#define VERSION_INTERNAL_BUILD		13  // Build day

#define VERSION_STRING				"Day-13,Month-06,Year-26,BuildNum-07" // build date
#define VERSION_STRING_DOTTED		"Day-13,Month-06,Year-26,BuildNum-07" // build date
#if defined(_DEBUG)
