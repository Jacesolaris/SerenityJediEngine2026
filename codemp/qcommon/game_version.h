...
#define VERSION_INTERNAL_BUILD		12  // Build number

#define VERSION_STRING				"Day-27,Month-08,Year-26,BuildNum-12" // build date
#define VERSION_STRING_DOTTED		"Day-27.Month-08.Year-26.BuildNum-12" // build date
#if defined(_DEBUG)
