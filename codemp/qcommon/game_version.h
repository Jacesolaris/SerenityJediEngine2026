...
#define VERSION_INTERNAL_BUILD		16  // Build day

#define VERSION_STRING				"Day-16,Month-06,Year-26,BuildNum-08" // build date
#define VERSION_STRING_DOTTED		"Day-16,Month-06,Year-26,BuildNum-08" // build date
#if defined(_DEBUG)
