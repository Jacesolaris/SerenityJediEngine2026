...
#define VERSION_INTERNAL_BUILD		30  // Build day

#define VERSION_STRING				"Day-30,Month-06,Year-26,BuildNum-11" // build date
#define VERSION_STRING_DOTTED		"Day-30,Month-06,Year-26,BuildNum-11" // build date
#if defined(_DEBUG)
