...
#define VERSION_INTERNAL_BUILD		26  // Build day

#define VERSION_STRING				"Day-26,Month-01,Year-26,BuildNum-02" // build date
#define VERSION_STRING_DOTTED		"Day-26,Month-01,Year-26,BuildNum-02" // build date
