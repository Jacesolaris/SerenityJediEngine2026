...
{
	Cbuf_ExecuteText(EXEC_NOW, "exec SerenityJediEngine2026-MP-default.cfg\n");
...
static void Com_WriteConfigToFile(const char* filename)
{
	...
	FS_Printf(f, "// generated by SerenityJediEngine2026 MP, do not modify\n");
	Key_WriteBindings(f);
...
void Com_WriteConfig_f(void)
{
	...
	if (!FS_FilenameCompare(filename, "SerenityJediEngine2026-MP-default.cfg") || !FS_FilenameCompare(filename, "SerenityJediEngine2026-SP-default.cfg"))
	{
