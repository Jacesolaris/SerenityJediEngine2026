...
extern void player_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const int damage, const int means_of_death, const int dflags = 0, const int hit_loc = HL_NONE);
...
extern void func_usable_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int dflags = 0, int hit_loc = HL_NONE);
extern void turret_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int meansOfDeath, int dflags = 0,
	int hit_loc = HL_NONE);
