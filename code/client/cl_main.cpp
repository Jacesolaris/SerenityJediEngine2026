...
// NOTENOTE: If you change the output name of SerenityJediEngine2026-rdsp, change this define too!

#define DEFAULT_RENDER_LIBRARY	"SerenityJediEngine2026-rdsp"
...
void CL_Init()
{
	...
	Com_Printf("---------------------Build date 29/01/2026-----------------------\n"); // build date
	Com_Printf("-----------------------------------------------------------------\n");
