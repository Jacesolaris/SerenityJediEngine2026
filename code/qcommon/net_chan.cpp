...
===========================
Netchan_Transmit
- Sends a packet or packet fragments over the network.
- Fixed MSVC C6262 by moving large send_buf off the stack.
===========================
*/
...
===========================
NET_OutOfBandPrint
- Sends an out-of-band text message.
- Fixed MSVC C6262 by moving large string buffer off the stack.
===========================
*/
