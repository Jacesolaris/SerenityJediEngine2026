...
using itemDef_t = struct itemDef_s
{
	...
	float textalignx = 0; // ( optional ) text alignment x coord
	float textaligny = 0; // ( optional ) text alignment y coord
	float text2alignx = 0; // ( optional ) text2 alignment x coord
	float text2aligny = 0; // ( optional ) text2 alignment y coord
	float textscale = 0; // scale percentage from 72pts
